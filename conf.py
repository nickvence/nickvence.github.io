...
# ! (b) BLOG_TITLE = {"en": "My Blog"}
# ! Option (a) is used when you don't want that setting translated.
# ! Option (b) is used for settings that are different in different languages.


# Data about this site
BLOG_AUTHOR = "Nicholas Vence"  # (translatable)
BLOG_TITLE = "Applied Stats"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nickvence.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "nickvence@gmail.com"
BLOG_DESCRIPTION = "Nicholas Vence's portfolio and statistics blog"  # (translatable)
...
CATEGORY_DESCRIPTIONS = {
    DEFAULT_LANG: {
        "Research": "Summaries of my peer-reviewed publications.",
        "Data Science": "Probability, statistics, modeling algorithms, computer languages and libraries"
    },
}
